...
mod tests {
    use super::*;
    #[test]
    pub fn example_part_a_code_block_from_aoc() {
        let input_lines = read_input("./inputs/test_input_easy.txt").unwrap();
        assert_eq!(part_a(input_lines), "32");
    }

    #[test]
    pub fn example_part_a_10_from_aoc() {
        let input_lines = read_input("./inputs/test_input_0.txt").unwrap();
        assert_eq!(part_a(input_lines), "8317");
    }

    #[test]
    pub fn example_part_a_13_from_aoc() {
        let input_lines = read_input("./inputs/test_input_1.txt").unwrap();
        assert_eq!(part_a(input_lines), "146373");
    }

    #[test]
    pub fn example_part_a_17_from_aoc() {
        let input_lines = read_input("./inputs/test_input_2.txt").unwrap();
        assert_eq!(part_a(input_lines), "2764");
    }

    #[test]
    pub fn example_part_a_21_from_aoc() {
        let input_lines = read_input("./inputs/test_input_3.txt").unwrap();
        assert_eq!(part_a(input_lines), "54718");
    }

    #[test]
    pub fn example_part_a_30_from_aoc() {
        let input_lines = read_input("./inputs/test_input_4.txt").unwrap();
        assert_eq!(part_a(input_lines), "37305");
    }

    #[test]
    pub fn answer_part_a_from_aoc() {
        let input_lines = read_input("./inputs/input.txt").unwrap();
        assert_eq!(part_a(input_lines), "390093");
    }

    // This test runs for a while, so it's ignored by default
    #[test]
    #[ignore]
